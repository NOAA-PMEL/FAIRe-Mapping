...
def main() -> None:
    ...
    sample_mapper.add_final_df_to_FAIRe_excel(sheet_name=sample_mapper.sheet_name, faire_template_df=faire_sample_df)
...
####################### JV Experiment Run3 ##########################################################
    ...
    # Step 3: Add related mappings
    for faire_col, metadata_col in run3_mapper.mapping_dict[sample_mapper.related_mapping].items():
        # Add assay
