...
def main() -> None:
    ...
    ncbi_mapper = NCBIMapper(final_faire_sample_metadata_df=sample_metadata_df, 
                             ...
                             ncbi_sample_excel_save_path='/home/poseidon/zalmanek/FAIRe-Mapping/runs/osu1037/ncbi_mapping/ncbi_submission_data/osu1037_MIMARKS.survey.water.6.0.xlsx',
                             ncbi_sra_excel_save_path = '/home/poseidon/zalmanek/FAIRe-Mapping/runs/osu1037/ncbi_mapping/ncbi_submission_data/osu1037_SRA_metadata.xlsx',
