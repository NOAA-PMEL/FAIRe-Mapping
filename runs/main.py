...
def create_exp_run_metadata(config_yaml: str) -> pd.DataFrame:
    ...
    exp_mapper.save_final_df_as_csv(final_df=faire_exp_df, csv_path='/home/poseidon/zalmanek/FAIRe-Mapping/runs/run4/data/run3_faire_experimentRunMetadata.csv')
