...
def create_m2_pps_0423_sample_metadata():
    ...
    faire_sample_df_cruise_code_updated = sample_mapper.fix_cruise_code_in_samp_names(df=faire_sample_df_updated, 
                                                                                      cruise_code_to_replace='.DY2306',
                                                                                      replacement='DY23-06')

    # step 7: save as csv:
    sample_mapper.save_final_df_as_csv(final_df=faire_sample_df_cruise_code_updated, sheet_name=sample_mapper.sample_mapping_sheet_name, header=2, csv_path='/home/poseidon/zalmanek/FAIRe-Mapping/projects/EcoFoci/m2_pps_0423/data/m2_pps_0423_faire.csv')
